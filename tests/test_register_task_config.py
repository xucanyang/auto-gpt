...
class RegisterTaskConfigTests(unittest.TestCase):
    ...
    def test_runtime_capacity_update_is_normalized_and_restarts_solver(self):
            ...
            result = config_api.update_config(
                config_api.ConfigUpdate(
                    data={
                        ...
                        "chatgpt_runtime_auth_browser_registration_reserve": 6,
                        "chatgpt_runtime_auth_browser_recheck_reserve": 4,
        ...
        self.assertEqual(saved["chatgpt_runtime_auth_browser_registration_reserve"], "6")
        self.assertEqual(saved["chatgpt_runtime_auth_browser_recheck_reserve"], "4")
