...
class WebSessionLoginTests(unittest.TestCase):
    ...
    def _captured_session(
        ...
        *,
        ...
        browser_fingerprint["device_id"] = "device-new"
        return {
            "access_token": "at-new",
    ...
    def test_legacy_browser_override_migrates_profile_only_after_success(self):
        ...
        migrated_profile = build_browser_fingerprint_payload(
            ensure_deep_browser_fingerprint(requested_profile)
        )
        captured = self._captured_session(browser_family="chrome")
        ...
        self.assertEqual(stored["browser_family"], "chrome")
        self.assertEqual(stored["browser_backend"], "patchright_chromium")
        self.assertEqual(stored["operating_system"], "linux")
        self.assertEqual(stored["device_id"], "device-new")
        self.assertEqual(extra["refresh_token"], "rt-preserved")
        self.assertTrue(extra["manually_used"])

    def test_existing_account_without_fingerprint_uses_and_persists_patchright_profile(self):
        ...
        with (
            ...
            mock.patch.object(
                ...
                "capture_web_session_without_refresh_token",
                return_value=(
                    self._captured_session(browser_family="chrome"),
                    {
                        "provider": "dummy",
